...
/// </summary>
/// <remarks>
/// Собирается в <see cref="Workers.WorkerManager.GetWorkers"/> и отдаётся на клиент как <see cref="Dto.WorkerSkillDto"/>.
/// </remarks>
public class WorkerSkill
{
    /// <summary>
    /// Тип построек, в котором накоплен опыт – ссылка на <see cref="Core.Models.DomikType.Id"/>.
    /// </summary>
